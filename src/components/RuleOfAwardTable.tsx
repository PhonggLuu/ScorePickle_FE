...
import { useGetRuleOfAward } from '@src/modules/Tournament/hooks/useGetRuleOfAward';
import { RuleOfAward } from '@src/modules/Tournament/models/index';
...
const RuleOfAwardTable: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'percentOfPrize',
      render: (percentOfPrize: string) => <h2>{percentOfPrize} %</h2>,
    },
  ];
    ...
    return (
      <div style={{ textAlign: 'center', padding: '24px' }}>
        ...
        <Text style={{ display: 'block', marginTop: '16px' }}>
          Loading prize distribution rules...
        </Text>
      </div>
    );
  }
