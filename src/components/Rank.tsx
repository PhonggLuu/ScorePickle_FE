...
import { useGetLeaderboardByTournamentId } from '@src/modules/Tournament/hooks/useGetLeaderboardByTournamentId';
import { RankPlayer } from '@src/modules/Tournament/models';
    ...
    >
      ...
      >
        <Title level={3} style={{ textAlign: 'center', marginBottom: 30 }}>
          ...
          <span style={{ color: '#fff' }}> Tournament Champions</span>
        </Title>
      </motion.div>
