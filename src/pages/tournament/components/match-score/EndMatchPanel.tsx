  ...
  return (
    <>
        ...
        <Alert
          ...
          description={
            <div>
              <p>
                <Text>
                  Only locally created or modified scores will be submitted to
                  the server.
                </Text>
              </p>
              <p>
                ...
                <ul>
                  <li>
                    <Tag color="blue">From API: {apiScoresCount}</Tag> - Already
                    on the server
                  </li>
                  <li>
                    <Tag color="green">Local changes: {localScoresCount}</Tag> -
                    Will be submitted
                  </li>
                </ul>
              </p>
              {localScoresCount === 0 && (
                <Text type="warning">
                  No local scores to submit. You can close this modal.
                </Text>
              )}
            </div>
          }
      ...
      <Space>
        ...
        >
          {localScoresCount > 0
            ? `Submit ${localScoresCount} Local Score${
                localScoresCount > 1 ? 's' : ''
              }`
