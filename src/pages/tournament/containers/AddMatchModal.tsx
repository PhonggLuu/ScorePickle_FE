...
const AddMatchModal: React.FC<AddMatchModalProps> = ({
  ...
  useEffect(() => {
    if (tournamentDetails?.type) {
      ...
      const defaultFormat =
        TOURNAMENT_TYPE_TO_FORMAT[tournamentDetails.type] ||
        MatchFormat.SingleMale;
  ...
  const pairTeamsRandomly = () => {
    ...
    for (let i = 0; i < shuffledTeams.length; i += 2) {
      if (shuffledTeams[i + 1]) {
        pairs.push([
          shuffledTeams[i] as RegistrationDetail,
          shuffledTeams[i + 1] as RegistrationDetail,
        ]);
      }
    }
          ...
          <Alert
            ...
            description={
              <Space direction="vertical" size="small">
                <Text type="secondary">
                  <CalendarOutlined /> Tournament Period:{' '}
        ...
        <Collapse defaultActiveKey={['1']}>
          ...
          >
            <Alert
              ...
              description={
                <div>
                  Only approved teams (status: Approved) are available for
                  selection.
                  {assignedTeams.length > 0 && (
                    <Text strong> {assignedTeams.length} teams</Text>
                  )}{' '}
                  have been assigned to matches.
                </div>
              }
              type="info"
              showIcon
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    ...
                    label="Team 1"
                    rules={[
                      { required: true, message: 'Please select team 1!' },
                    ]}
                  >
                    <Select
                      showSearch
                      ...
                      notFoundContent={
                        hideAssignedTeams
                          ? "No more available teams. Try disabling 'Hide assigned teams'."
                ...
                <Col span={12}>
                  <Form.Item
                    ...
                    label="Team 2"
                    rules={[
                      { required: true, message: 'Please select team 2!' },
                    ]}
                  >
                    <Select
                      showSearch
