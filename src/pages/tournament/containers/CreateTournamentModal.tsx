...
const CreateTournamentModal: React.FC<CreateTournamentModalProps> = ({
  ...
  const handleSubmit = (values: any) => {
    ...
    const tournamentData: TournamentRequest = {
      ...
      sponerDetails: values.sponerDetails || 'No sponsor details provided', // Added sponerDetails
    };
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <Select
                style={{ width: '100%' }}
                placeholder="Select minimum ranking"
              >
          ...
          <Col span={12}>
            ...
            >
              <Select
                style={{ width: '100%' }}
                placeholder="Select maximum ranking"
              >
                {Array.from({ length: 9 }, (_, i) => i + 1).map((value) => (
                  <Option key={value} value={value}>
                    {value}
