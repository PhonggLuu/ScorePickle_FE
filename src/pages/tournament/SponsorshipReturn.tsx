...
import { Card, Button, Form, Row, Col, Image, Descriptions } from 'antd';
...
const SponsorshipReturn: React.FC = () =>
  //{
  //   response,
  //   vnp_Amount,
  //   vnp_BankCode,
  ...
  //}
  {
    ...
    const tournamentId = vnp_OrderInfo ? vnp_OrderInfo.split(':')[1] : null;
    const { data: tournament } = useGetTournamentById(
        ...
        >
          <div className="py-4">
            ...
            <Button
              ...
              onClick={() => {
                window.location.href = '/sponsor/payment';
              }}
            >
...
export default SponsorshipReturn;
