...
export const ContentPage: React.FC = () => {
  ...
  const [, setActiveRuleCategory] = useState<string | number>('all');
            ...
            <Button
              ...
              onClick={() => {
                Modal.confirm({
                  ...
                  content:
                    'Are you sure you want to delete this category? This will affect all associated content.',
                  okText: 'Yes',
                  okType: 'danger',
                  cancelText: 'No',
                  onOk() {
                    ...
                    tab={
                      <span>
                        ...
                        <Badge
                          ...
                          style={{
                            marginLeft: 8,
                            backgroundColor: category.rules.length
                              ? '#52c41a'
                              : '#d9d9d9',
                          }}
                        />
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              ruleForm.setFieldsValue({
                                blogCategoryId: category.categoryId,
                              });
                              setSelectedRule(null);
                              setRuleContent('');
                              resetImageStates();
      ...
      >
        <div style={{ textAlign: 'center' }}>
          {previewImageUrl ? (
            ...
            <div
              className="content-preview-full"
